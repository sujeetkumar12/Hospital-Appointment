...
const Login = () => {
  ...
  return (
    <form className='min-h-[80vh] flex items-center' autocomplete="off" >
      <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-zinc-600 text-sm shadow-lg'>
        ...
        {
          state !== "Sign Up"
            ? <p>Already have an Account <span onClick={() => setState('Sign Up')} className='text-primary underline cursor-pointer'>Login here</span></p>
            : <p>Create an new account? <span onClick={() => setState('Login')} className='text-primary underline cursor-pointer'>click here</span> </p>
        }
      </div>
